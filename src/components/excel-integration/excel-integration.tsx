...
import { ExcelConfig } from '../../services/excelService';
...
const ExcelIntegration: React.FC<ExcelIntegrationProps> = ({ shipments, onShipmentsUpdate }) => {
            ...
            {isExcelEnabled && excelConfig && (
                <div className="excel-integration-content">
                    ...
                    <div className="excel-info">
                        <h4>Como funciona:</h4>
                        <ul>
                            <li>✅ <strong>Sincronização em tempo real:</strong> Dados são atualizados automaticamente</li>
                            <li>✅ <strong>Mapeamento inteligente:</strong> Campos são mapeados automaticamente</li>
                            <li>✅ <strong>Webhook:</strong> Recebe notificações quando Excel é modificado</li>
                            <li>✅ <strong>Bidirecional:</strong> Pode enviar e receber dados</li>
                        </ul>
                    </div>
                </div>
            )}
            ...
            {!isExcelEnabled && (
                <div className="excel-integration-placeholder">
                    <div className="placeholder-content">
                        ...
                        <p>Conecte sua planilha Excel Online para sincronização em tempo real com o sistema.</p>
